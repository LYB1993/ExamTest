      ...
      <section id="main-content">
      		...
      		<div class="row">
      		 	<div class="col-lg-12">
		  	 		...
		  	 		<li><i class="icon_document_alt"></i><a href="toChoice.do">科目选择</a></li>
		  	 		</ol>
		  	 	</div>         	
        		<div class="panel panel-default">
        			<div class="panel-heading">
        				<div class="col-lg-12">
        					<strong><h1>选择考试的科目</h1></strong>
        				</div>
        			</div>
        			<c:forEach items="${examPageList }" var="bl">
        				<a href="toExamTest.do?choice=${bl }" onclick="onstart();">
        				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box red-bg">
								<i class="icon_document_alt"></i>
								<div><strong>${bl }</strong></div>						
							</div>		
						</div>
						</a>
        				</c:forEach>
